...
#if defined(NDEBUG)
# error "Maxcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x71b0149740c6ec7423182ab6d3cd103459b6af8a2fd335889f7859d9d44b81a8");
...
static const int64 nTargetTimespan = 2 * 60; // Maxcoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // Maxcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x71b0149740c6ec7423182ab6d3cd103459b6af8a2fd335889f7859d9d44b81a8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "RNG won";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x84153af2fdf6c0c49dc6f5fc94cef30b4c3feb2abc9eedc333e40254a503d1ea"));
        block.print();
